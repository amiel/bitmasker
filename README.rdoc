...
Bitmask Attributes allows you to store many boolean values in one integer field.
...
this will create 8 functions: 
* User#notifications -- returns a Bitmask object representing all values
...
==== attribute(name, mask, default = false)
Sets up a binary attribute. Creates three functions: name, name?, and name=(true|false)
...
at the moment, if you reload the model, you still have the old Bitmask object instance
